...
#[no_mangle]
pub extern "C" fn frost_sign_commit(
...
#[no_mangle]
pub extern "C" fn frost_sign_new_package(
...
pub(crate) mod tests {
    ...
    pub fn run_sign(key_results: &[(Vec<u8>, Vec<u8>)], signer_indices: &[usize]) {
        ...
        for &idx in signer_indices {
            ...
            assert_eq!(
                frost_sign_commit(Some(&kp_slice), Some(&mut nonces), Some(&mut commitments)),
                lib_error::LIB_OK,
            );
